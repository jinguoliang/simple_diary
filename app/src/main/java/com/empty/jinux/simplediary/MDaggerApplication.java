 ...
 */
@Beta
public abstract class MDaggerApplication extends MultiDexApplication
     ...
     */
    protected abstract AndroidInjector<? extends MDaggerApplication> applicationInjector();
        ...
        if (needToInject) {
            synchronized (this) {
                if (needToInject) {
                    ...
                    AndroidInjector<MDaggerApplication> applicationInjector =
                            (AndroidInjector<MDaggerApplication>) applicationInjector();
